...
/**
 * unitPricePaise and gstRatePercent are snapshots at sale time
 * (PROJECT_SKILLS #17) - a later change to product.sellingPricePaise must
 * never rewrite an already-issued invoice line. Never updated once written.
 */
@Entity
