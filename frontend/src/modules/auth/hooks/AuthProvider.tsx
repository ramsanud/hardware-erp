...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo<AuthContextValue>(
    ...
    [user, initialising, mustChangePassword, mfaToken, enrollmentRequired, mfaMethod, emailHint,
      login, cancelPendingLogin, verifyMfa, enrollMfa, confirmMfaEnroll, resendEmailCode,
      logout, logoutAll, refreshUser, hasPermission, hasAnyPermission],
  );
